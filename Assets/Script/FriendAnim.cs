...
public class FriendAnim : MonoBehaviour
{
    ...
    private FriendController player;


    // Start is called before the first frame update
    void Start()
    {
        player = GameObject.FindObjectOfType<FriendController>();   // get Reference to player
    ...
    void Update()
    {
        ...
        else if (player.GetMoveLeft() || player.GetMoveRight())
        {
